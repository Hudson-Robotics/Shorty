...
public class Robot extends TimedRobot {
  ...
  WPI_TalonSRX motorLftMaster = new WPI_TalonSRX(2);
  WPI_TalonSRX motorLftSlave = new WPI_TalonSRX(3);
  WPI_TalonSRX motorRtMaster = new WPI_TalonSRX(4);
  WPI_TalonSRX motorRtSlave = new WPI_TalonSRX(5);
  ...
  private void Drive(double rampUp, double rampDown, double maximum, double deadBand) {
    ...
    drvMode.arcadeDrive(Math.pow(-xBoxCtrlr.getY(Hand.kLeft) * maximum, pow),
        Math.pow(xBoxCtrlr.getX(Hand.kLeft) * maximum, pow));
